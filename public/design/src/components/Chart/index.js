...
export default class Chart extends Base {
	...
	chooseChartPreriod(e) {
		...
		switch ($(e.currentTarget).text()) {
			case 'Все время':
				this.getAllPeriod(chart);
				break;
			case 'Год':
				this.getYearPeriod(chart, currentYear, currentMonth, currentDay);
				break;
			case 'Квартал':
				this.getQuarterPeriod(chart, currentYear, currentMonth, currentDay);
				break;
			case 'Месяц':
				this.getMonthPeriod(chart, currentYear, currentMonth, currentDay);
				break;
			case 'Неделя':
				this.getWeekPeriod(chart, currentYear, currentMonth, currentDay);
				break;
			case 'День':
				this.getDayPeriod(chart);
				break;
			case 'Час':
				this.getHourPeriod(chart);
				break;
			case 'Минута':
				this.getMinutePeriod(chart);
				break;
			default:
				this.getAllPeriod(chart);
		}
	...
	updateChartOption(chart, marker, yTickInterval) {
		chart.update({
			plotOptions: {
			    series: {
			        marker: {

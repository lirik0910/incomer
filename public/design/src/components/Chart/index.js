	 ...
	 //      1541514600000,
	    ...
	    //         		pointInterval: 1 * 3600 * 1000
				...
				chart.update({
				    ...
				    // xAxis: {
				    // 	pointStart: Date.UTC(beforeYear, beforeMonth, beforeDay),
		...
		$('.chart__filter-link').eq(2).on('click', function() {
			...
			var chart = Highcharts.charts[0],
		  	...
		  	chart.xAxis[0].setExtremes(max - interval, max);
				 ...
				 // var beforeDate = new Date(currentYear, currentMonth, currentDay - 1);
				 // var beforeYear = beforeDate.getFullYear();
				 // var beforeMonth = beforeDate.getMonth();
				 // var beforeDay = beforeDate.getDate();
		...
		tooltip: {
			...
			events: {
					setExtremes: function(e) {
									...
									// if(typeof(e.rangeSelectorButton.type) === 'week') {
										// var dateStart = new Date();
										// var dateEnd = dateStart.setDate(dateStart.getMonth()-1);
			 ...
			 //            	var d = new Date();
						...
						// console.log(d);
						// var from = new Date(d.setMonth(d.getMonth() - 1));

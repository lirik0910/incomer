...
export const SidebarMiddleNav = () => (
    <SidebarMenu>
        <SidebarMenu.Item title="Новости" to='/news' icon={<i className="fa fa-fw fa-newspaper-o" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="Прототипы" to='/prototypes' icon={<i className="fa fa-fw fa-file-text-o" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="Видео" to='/video' icon={<i className="fa fa-fw fa-video-camera" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="База знаний" to='/library' icon={<i className="fa fa-fw fa-book" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="Cтатистика" to='/statistics' icon={<i className="fa fa-fw fa-bar-chart" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="Пользователи" to='/users' icon={<i className="fa fa-fw fa-users" aria-hidden="true"></i>} exact />
        <SidebarMenu.Item title="Настройки" to='/settings' icon={<i className="fa fa-fw fa-gear" aria-hidden="true"></i>} exact />
        ...
        <SidebarMenu.Item
            ...
            title="Versions"
        >
            <SidebarMenu.Item title="React 2.0" href='http://v2.react.spin.webkom.co' />
            <SidebarMenu.Item title="React 1.0" href='http://v1.react.spin.webkom.co' />
            <SidebarMenu.Item title="JQuery 1.0" href="http://v1.spin.webkom.co" />
        </SidebarMenu.Item>
    </SidebarMenu >
);

...
class LayoutComponent extends Component {
	...
	selectImage: Function = (url): void => {
		this.setState({ imgSrc: window.location.origin + url });
	};
	...
	render(): Object {
		...
		return (
			...
			>
				...
				{expanded || holdExpanded ? this.renderAddImageModal() : undefined}
			</div>
		);
	}
}

                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" active>
                                        <Badge color="primary" className="align-self-center mr-2">
                                            Waiting
                                        </Badge> 
                                        Profile
                                    </NavLink>
                                ...
                                <NavItem>
                                    <NavLink href="#">
                                        <Badge color="info" className="align-self-center mr-2">
                                            Doing
                                        </Badge> 
                                        Settings
                                    </NavLink>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" active className="flex-sm-fill d-flex justify-content-between">
                                        <Badge color="primary" className="align-self-center">
                                            2.562
                                        </Badge> 
                        ...
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" active>
                                        Profile
                                        <Badge color="primary" pill className="ml-auto align-self-center">3</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex">
                                        Settings
                                        <Badge color="info" pill className="ml-auto align-self-center">15</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" disabled>
                        ...
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" active>
                                        Profile
                                        <Badge color="primary" className="ml-auto align-self-center">
                                            Added
                                        </Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex">
                                        Settings
                                        <Badge color="info" className="ml-auto align-self-center">
                                            Query
                                        </Badge>
                                    </NavLink>
                                </NavItem>
                        ...
                        <CardBody>
                            ...
                            <Nav pills className="nav-justified">
                                <NavItem>
                                    <NavLink href="#" active>
                                        Profile
                                        <Badge color="primary" pill className="align-self-center ml-2">3</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#">
                                        Settings
                                        <Badge color="info" pill className="align-self-center ml-2">9</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" disabled>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills className="nav-justified">
                                <NavItem>
                                    <NavLink href="#" active>
                                         <Badge color="primary" pill className="align-self-center mr-2">3</Badge>
                                        Profile
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#">
                                        <Badge color="info" pill className="align-self-center mr-2">9</Badge>
                                        Settings
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav pills>
                                <NavItem>
                                    <NavLink href="#" active>
                                         <Badge color="primary" pill className="align-self-center mr-2">1</Badge>
                                        Profile
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#">
                                        <Badge color="info" pill className="align-self-center mr-2">2</Badge>
                                        Settings
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                        ...
                        <CardBody>
                            ...
                            <Nav pills className="nav-justified">
                                ...
                                <NavItem>
                                    <NavLink href="#">
                                        Settings
                                        <Badge color="info" className="align-self-center ml-2">
                                            $821
                                        </Badge>
                                    </NavLink>
                                </NavItem>
                        ...
                        <CardBody>
                            ...
                            <Nav pills className="nav-justified">
                                <NavItem>
                                    <NavLink href="#" active>
                                        Profile
                                        <Badge color="primary" className="align-self-center ml-2">
                                            1
                                        </Badge>
                                    </NavLink>
                                </NavItem>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Nav tabs>
                                <NavItem>
                                    <NavLink href="#" active>
                                        <Badge color="primary" pill className="align-self-center">3</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#">
                                        <Badge color="info" pill className="align-self-center">9</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" disabled>

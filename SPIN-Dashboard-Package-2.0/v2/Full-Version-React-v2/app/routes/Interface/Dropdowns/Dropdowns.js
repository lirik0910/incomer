                        ...
                        <CardBody>
                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    ...
                                    <DropdownItem className="d-flex">
                                        Settings
                                        <Badge color="info" className="align-self-center ml-auto">
                                            Error
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem divider />
                                    <DropdownItem className="d-flex">
                                        Logout
                                        <Badge color="secondary" className="align-self-center ml-auto">
                                            Safe
                                        </Badge>
                                    </DropdownItem>
                                </DropdownMenu>
                        ...
                        <CardBody>
                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    ...
                                    <DropdownItem className="d-flex">
                                        Settings
                                        <Badge pill color="info" className="align-self-center ml-auto">
                                            12
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem divider />

            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault101" color="secondary">
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault102" color="secondary">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
        ...
        <CardGroup>
            ...
            <Card className="mb-3 text-center">
                <CardBody>
                    ...
                    <Button id="modalDefault201" color="secondary" size="sm">
                        See Modal  <i className="fa fa-angle-right ml-1"></i>
                    </Button>
                    { /* START Example Modal */}
            ...
            <Card className="mb-3 text-center">
                <CardBody>
                    ...
                    <Button id="modalDefault202" color="secondary">
                        See Modal  <i className="fa fa-angle-right ml-1"></i>
                    </Button>
                    { /* START Example Modal */}
            ...
            <Card className="mb-3 text-center">
                <CardBody>
                    ...
                    <Button id="modalDefault203" color="secondary" size="lg">
                        See Modal  <i className="fa fa-angle-right ml-1"></i>
                    </Button>
                    { /* START Example Modal */}
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault301" color="primary">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault301" className="b-primary">
                            <ModalHeader tag="h6">
                                <span className="text-primary">
                                    Modal: Primary
                                </span>
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault302" color="danger">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault302" className="b-danger">
                            <ModalHeader tag="h6">
                                <span className="text-danger">
                                    Modal: Danger
                                </span>
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault303" color="info">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault303" className="b-info">
                            <ModalHeader tag="h6">
                                <span className="text-info">
                                    Modal: Info
                                </span>
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault304" color="warning">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault304" className="b-warning">
                            <ModalHeader tag="h6">
                                <span className="text-warning">
                                    Modal: Warning
                                </span>
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault305" color="success">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault305" className="b-success">
                            <ModalHeader tag="h6">
                                <span className="text-success">
                                    Modal: Success
                                </span>
            ...
            <Col lg={ 6 }>
                ...
                <Card className="mb-3 text-center">
                    <CardBody>
                        ...
                        <Button id="modalDefault306" color="dark">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault306" className="b-gray-500">
                            <ModalHeader tag="h6">
                                <span className="text-white">
                                    Modal: Dark
                                </span>
